...
public static class Extensions
{
    ...
    public static TextBox DrawTextBox(this Canvas canvas,
        Rect bounds, object content,
        Brush background, Brush foreground,
        HorizontalAlignment h_align,
        VerticalAlignment v_align,
        double font_size, double padding)
    {
        ...
        box.SetElementBounds(bounds);
        box.Foreground = foreground;
        box.Background = background;
        box.HorizontalContentAlignment = h_align;
        box.VerticalContentAlignment = v_align;
